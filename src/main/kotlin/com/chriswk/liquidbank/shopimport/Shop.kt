...
data class Shop(val timestamp: ZonedDateTime, @Id val shopId: String, val shopname: String?, val streetAddress: String?, val postalCode: String?,
                val postalCity: String?, val postalAddress: String?, val postalPostCode: String?, val postalPostCity: String?,
                val phoneNo: String?, val category: String?, val position: GeoPoint?, val weekNumber: Int?,
